    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condenser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fittings', related_query_name='fitting', to='mailcondensers.MailCondenser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_field', models.CharField(choices=[('Attachment', 'Attachment'), ('Attachments', 'Attachments'), ('Date', 'Date'), ('To', 'To'), ('From', 'From'), ('Subject', 'Subject'), ('Content', 'Content')], help_text='The email field from which data will be extracted.', max_length=255)),
            ],
            options={
                'abstract': False,
            },
